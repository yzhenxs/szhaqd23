<template>
    <div>
        ...
        <div v-for="item in goodsList" v-bind:key="item.level1cateid" class="section">
            <div class="main-tit">
                <h2>{{item.catetitle}}</h2>
                <p>
                    <a v-for="subitem in item.level2catelist"  v-bind:key="subitem.subcateid"  href="/goods/43.html">{{subitem.subcatetitle}}</a>
            ...
            <div class="wrapper clearfix">
                <div class="wrap-box">
                    <ul class="img-list">
                        <li v-for="subitem in item.datas" v-bind:key="subitem.artID">
