        ...
        <div class="head-top">
            <div class="section">
                ...
                <div id="menu" class="right-box">
                    <span v-if="!isLogin">
                        <router-link to="/login" class="">登陆</router-link>
                        <strong>|</strong>
                        <a href="" class="">注册</a>
                        <strong>|</strong>
                    </span>
                    <span>
                        <router-link to="/vipCenter" class="" v-if="isLogin">会员中心</router-link>
                        <strong>|</strong>
                        <a @click="logout" v-if="isLogin">退出</a>
                        <strong>|</strong>
                    </span>
                    <router-link to="/shopcart" href="" class="">
